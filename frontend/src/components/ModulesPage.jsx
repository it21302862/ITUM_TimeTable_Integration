...
const ModulesPage = () => {
  ...
  const openEditModal = (course) => {
    ...
    setForm({
      ...
      room: course.room || "", // if you later add this field
    });
    setIsModalOpen(true);
  };
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-[#e7ebf3] dark:border-gray-800 overflow-hidden">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <div className="size-7 rounded-full bg-primary/10 text-primary flex items-center justify-center text-[10px] font-bold">
                            {course.Instructor?.name?.slice(0,2).toUpperCase() || "NA"}
                          </div>
              ...
              <div className="px-6 py-4 bg-gray-50 dark:bg-gray-800/30 border-t border-[#e7ebf3] dark:border-gray-800 flex items-center justify-between text-xs text-gray-500">
                <span>Showing 1 to {courses.length} of {courses.length} modules</span>
                <div className="flex items-center gap-1">
                  <button disabled className="p-1 rounded hover:bg-gray-200 dark:hover:bg-gray-700 disabled:opacity-30">
                    <span className="material-symbols-outlined">chevron_left</span>
                  </button>
                  <button className="size-8 rounded bg-primary text-white font-bold">1</button>
                  <button className="size-8 rounded hover:bg-gray-200 dark:hover:bg-gray-700">2</button>
              ...
              <div className="space-y-6">
                <div className="p-4 bg-primary/5 rounded-xl border border-primary/10">
                  ...
                  <div className="mt-4 space-y-3 text-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <span className="text-gray-400 text-[11px]">Instructor</span>
                        <p className="font-semibold">{selected.Instructor?.name || "—"}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                ...
                <div className="pt-4 flex flex-col gap-3 border-t border-gray-100 dark:border-gray-800">
                  <button
                    ...
                    className="w-full bg-primary text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors shadow-md"
                  >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-900 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Default Lab/Room</label>
                <div className="relative">
                  <select
                    name="room"
                    value={form.room}
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-800">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 text-sm font-bold bg-primary text-white rounded-xl shadow-lg shadow-primary/20 hover:bg-blue-700 transition-all"
                >
